  ...
  return (
    <div className={`rounded-xl p-3 transition-all duration-200 ${
      highlight
        ...
        : 'bg-white/[0.03] border border-white/[0.05] hover:bg-white/[0.05] hover:border-white/[0.08]'
    }`}>
      <p className="text-[9px] text-zinc-600 uppercase tracking-[0.12em] font-bold font-mono mb-2">
        {label}
      </p>
